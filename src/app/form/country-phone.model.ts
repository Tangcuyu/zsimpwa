...
export class CountryPhone {
  ...
  constructor(iso: string, name: string) {
    ...
    // We need to define what kind of country phone number type we are going to use as a mask.
        ...
        //    - FIXED_LINE
        //    - MOBILE
        //    - For more types please refer to google libphonenumber
        // repo (https://github.com/googlei18n/libphonenumber/blob/
        // f9e9424769964ce1970c6ed2bd60b25b976dfe6f/javascript/i18n/phonenumbers/phonenumberutil.js#L913)
